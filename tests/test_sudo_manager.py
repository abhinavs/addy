...
class TestSudoManager:
    ...
    def test_grant_sudo_success(self, mock_chmod, mock_file, mock_subprocess):
        ...
        with patch('pathlib.Path.exists', return_value=False), \
            ...
            mock_chmod.assert_called_with(mock_file.return_value.__enter__.return_value.name, 0o440)
    ...
    def test_grant_sudo_validation_fails(self, mock_unlink, mock_chmod, mock_file, mock_subprocess):
    ...
    def test_validate_sudoers_file_visudo_not_found(self, mock_subprocess):
        ...
        sudo_manager = SudoManager()
        assert sudo_manager._validate_sudoers_file(Path("/tmp/test")) is True  # Assume valid
    ...
    def test_is_addy_sudoers_file_false(self, mock_file):
        ...
        mock_file.return_value.read.return_value = "testuser ALL=(ALL) ALL"  # Missing NOPASSWD
