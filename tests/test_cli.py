...
class TestCLI:
    ...
    def test_config_set_command(self, mock_config_class, mock_geteuid):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['config', 'set', 'git-repo', 'git@github.com:test/repo.git'])
        
        assert result.exit_code == 0
        mock_config.set.assert_called_once_with('git-repo', 'git@github.com:test/repo.git')
    ...
    @patch('addy.cli.ConfigManager')
    def test_install_user_package(self, mock_config_class, mock_git_class, mock_user_class, mock_geteuid):
    ...
    @patch('addy.cli.GitRepository')
    @patch('addy.cli.ConfigManager')
    def test_install_sudo_package(self, mock_config_class, mock_git_class, mock_user_class, mock_sudo_class, mock_geteuid):
    ...
    @patch('addy.cli.GitRepository')
    @patch('addy.cli.ConfigManager')
    def test_install_sudo_user_not_exists(self, mock_config_class, mock_git_class, mock_user_class, mock_geteuid):
