...
class TestUserManager:
    ...
    @patch('pwd.getpwnam')
    def test_create_user_success(self, mock_getpwnam, mock_subprocess, mock_os_operations):
    ...
    @patch('os.chown')
    @patch('pwd.getpwnam')
    def test_install_ssh_key_success(self, mock_getpwnam, mock_chown, mock_chmod, mock_open):
        ...
        with patch('pathlib.Path.exists', return_value=False), \
            ...
            user_manager = UserManager()
            user_manager.install_ssh_key("testuser", "ssh-rsa AAAAB3... test@example.com")
    ...
    def test_list_users_with_ssh(self, mock_getpwall):
        ...
        with patch('pathlib.Path.exists') as mock_exists:
            ...
            mock_exists.side_effect = lambda path: "user1" in str(path) or "user2" in str(path)
