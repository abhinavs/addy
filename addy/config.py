...
class ConfigManager:
    ...
    def _ensure_config_dir(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Permission denied creating config directory: {self.config_dir}")
    ...
    def get_git_repo(self) -> str:
        ...
        if not repo:
            raise RuntimeError("Git repository not configured. Run: addy config set git-repo <repo-url>")
        return repo
